...
class Monstre : public Case{
    ...
    Paramètres : 
        ...
        est_fuite : bool (private)
        Permet de savoir si le joueur a choisi la fuite ou non
        est_vaincu : bool (private) 
        Permet de savoir si le monstre a été vaincu ou non
    ...
    Méthode : 
        ...
        Mis dans appliqueEffet pour polymorphisme, utilisée uniquement dans appliqueEffet
